...
class ResNet(nn.Module):
    def __init__(
        ...
        if nmb_classes > 0:
            self.class_layer = nn.Linear(output_dim, nmb_classes, bias=False)
        '''
    ...
    def forward_head(self, x):
        ...
        if self.class_layer is not None:
            return x, self.class_layer(x)
        return x
...
def get_parser():
    ...
    parser.add_argument("--nmb_classes", default=3000, type=int, help="number of prototypes")                    
